        ...
        <nav class="navbar navbar-expand">
            <div class="collapse navbar-collapse justify-content-between">
                ...
                <ul class="navbar-nav header-right">
                    ...
                    <li class="nav-item">
                        <button type="button" class="btn btn-rounded btn-info" onClick="window.location.reload();">Refresh Page</button>  
                    </li>
                    <li class="nav-item">
                        <button href="javascript:void(0)" type="button" class="btn btn-rounded btn-primary" data-toggle="modal" data-target="#addOrderModalside"><span class="btn-icon-left text-primary"><i class="fa fa-shopping-cart"></i></span>Add Pedido</button>  
                    </li>
