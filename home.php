						...
						<div class="card">
							<div class="card-header d-sm-flex flex-wrap d-block pb-0 border-0">
								<div class="mr-auto pr-3">
									<h4 class="text-black fs-20">Acompanhamento</h4>
										...
										<div class="row align-items-center">
											...
											<div class="col-sm-6 mb-sm-0 mb-3 text-center">
												...
												<a href="post-details.html"
													class="btn btn-primary light btn-rounded">Mais detalhes</a>
											</div>
										</div>
										<div class="row">
										...
										<div class="row align-items-center">
											...
											<div class="col-sm-6 mb-sm-0 mb-3 text-center">
												...
												<p class="fs-14">Lorem ipsum dolor sit amet, consectetur adipiscing
													elit, sed do </p>
												<a href="post-details.html"
													class="btn btn-primary light btn-rounded">More Details</a>
											</div>
										</div>
										<div class="row">
											<div class="col-sm-4 mb-md-0 mb-3">
								...
								<div class="d-flex flex-wrap mb-4">
									...
									<div class="card-action revenue-tabs">
										<ul class="nav nav-tabs" role="tablist">
											...
											<li class="nav-item">
												<a class="nav-link" data-toggle="tab" href="#session-duration"
									...
									<div class="card-body">
										<div class="row">
											<div class="col-sm-6 mb-sm-0 mb-3">
												<div class="media align-items-center">
													<div
														class="d-inline-block mr-3 position-relative donut-chart-sale2">
														<span class="donut2"
